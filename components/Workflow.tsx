    ...
    <WorkflowStyle>
      ...
      <div className="wrapper">
        ...
        <div className="second-card">
          ...
          <p>
            Draft a step by step roadmap to bringing my theoretical solution to
            life
          </p>
        </div>
        <div className="third-card">
          ...
          <h4>Communication</h4>
          <p>
            When I hit a roadblock while coding, I often google the solution or
            escalate to my team members.
          </p>
        </div>
